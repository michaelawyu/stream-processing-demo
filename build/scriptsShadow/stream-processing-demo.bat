...
set CLASSPATH=%APP_HOME%\lib\stream-processing-demo-0.1.0-all.jar

@rem Execute stream-processing-demo
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %STREAM_PROCESSING_DEMO_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
